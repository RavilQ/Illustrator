...
$(document).on("click", ".loadmore-btn", function (e) {
    ...
    fetch(link)
        .then(res => {
            ...
            document.getElementById("wihslistcontainer").innerHTML += data;
...
$(document).on("click", ".loadmore-btn-for-portraits", function (e) {
    e.preventDefault();
    ...
    fetch(link)
        .then(res => {
            ...
            document.getElementById("portraitcontainerforloadmore").innerHTML += data;
...
$(document).on("click", ".loadmore-btn-for-myorders", function (e) {
    e.preventDefault();
    ...
    fetch(link)
        .then(res => {
            ...
            document.getElementById("profilemyorderscontainerforloadmore").innerHTML += data;
